...
var obj = {
	...
	m: new Map([[new Map([[1,2]]),new Map([[3,4]])],['key1',1],['key2',BigInt(2)],['key3',/3/],[BigInt(2),'key2']]),
...
// console.log(obj2.m)
// obj2.m.forEach(element => {
// 	console.log(element instanceof Map);
// });
// console.log(obj.m.get(obj.m));